  ...
  if (state === 'loading') {
    return (
      <div className="grid min-h-dvh place-items-center">
        <p className="text-[0.875rem] text-fg-faint">확인하는 중…</p>
      </div>
    )
  }
    ...
    return (
      <div className="grid min-h-dvh place-items-center px-8">
        <div className="w-full max-w-[22rem] text-center">
          ...
          <h1 className="mt-8 mb-1.5 text-[0.9375rem]">관리자 로그인</h1>
          <p className="mb-6 text-[0.8125rem] text-fg-muted">허용된 GitHub 계정만 통과합니다.</p>

          <button
            type="button"
            onClick={signIn}
            className="flex w-full cursor-pointer items-center justify-center gap-2 rounded-sm border border-border-strong bg-fg px-4 py-2.5 font-[560] text-[0.875rem] text-bg transition-opacity hover:opacity-90 active:scale-[0.985]"
          >
          ...
          <p className="mt-4 text-[0.75rem] text-fg-faint leading-relaxed">
