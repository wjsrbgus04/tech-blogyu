...
export default function NotFound() {
  return (
    <div className="mx-auto flex min-h-dvh max-w-[30rem] flex-col items-center justify-center px-6 text-center">
      ...
      <p className="mb-8 text-[1.1875rem] text-fg-muted">
        주소가 바뀌었거나 아직 발행되지 않은 글일 수 있습니다.
      </p>
      <Link
        href="/"
        className="rounded-sm border border-border px-4 py-2 text-[1.125rem] text-fg-muted transition-colors hover:border-border-strong hover:text-fg"
      >
        글 목록으로
      </Link>
    </div>
